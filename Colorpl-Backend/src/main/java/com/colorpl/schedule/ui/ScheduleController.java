...
public class ScheduleController {
    ...
    public ResponseEntity<List<ScheduleListResponse>> getScheduleList() {
        return ResponseEntity.ok(scheduleListService.getScheduleList());
    }
    ...
    public ResponseEntity<List<ScheduleListResponse>> monthlyScheduleList(
        ...
        return ResponseEntity.ok(monthlyScheduleListService.monthlyScheduleList(from, to));
    }
    ...
    public ResponseEntity<Long> createCustomSchedule(
        ...
        URI uri = ServletUriComponentsBuilder.fromCurrentContextPath()
            .path("/schedules/{scheduleId}").buildAndExpand(scheduleId).toUri();
