...
public class PaymentService {
    ...
    public HashMap<String, Object> confirmPaymentFromReceipt(String receiptId, String authorizationHeader) {
        try {
            ...
            // ReservationDetailRequest 리스트 생성
            List<ReservationDetailRequest> reservationDetails = selectedSeatList.stream()
                    .map(seat -> {
            ...
            // 예약 생성 및 저장
            ReservationResponse reservation = reservationService.createReservation(memberId, reservationRequest);
