                ...
                routeData.second.forEach { segment ->
                    ...
                    pathOverlay.apply {
                        ...
                        color = when (segment.first().mode) {
                            0 -> ContextCompat.getColor(requireContext(), R.color.blue)
                            1 -> ContextCompat.getColor(requireContext(), R.color.imperial_red)
                            else -> ContextCompat.getColor(requireContext(), R.color.imperial_red)
                        }
                        outlineWidth = 5
                        map = naverMap
                    }
