...
import com.domain.usecaseimpl.review.ReviewEmpathyUseCaseImpl
...
interface UseCaseModule {
    ...
    @Binds
    @Singleton
    fun bindReservationScheduleUseCase(
    ...
    @Binds
    @Singleton
    fun bindsReviewEmpathyUseCase(
        reviewEmpathyUseCaseImpl: ReviewEmpathyUseCaseImpl
